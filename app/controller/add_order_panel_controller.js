...
Ext.define('Iron.controller.add_order_panel_controller', {
    ...
    create_wear_name_and_calc_result_price: function(record) {
        ...
        var wear_name = record.get('item_type_name') + " (" + record.get('gender') + "; " + record.get('color');


        if (record.get('is_home_weight') === 1)
            wear_name = record.get('item_type_name') + " (" + record.get('color');



        if (record.get('price_type') == "Штучный")
            wear_name += "; " + record.get('count') + " шт.";
        ...
        if (record.get('price_type') == "Штучный")
            wear_name += " ** Цена: " + record.get('price').toString() + " руб./шт.";
        else
        {

            if (record.get('is_home_weight') === 0)
                wear_name += " ** Цена " + add_order_panel.dress_weight_price + " руб./кг.";
            else
                wear_name += " ** Цена " + add_order_panel.home_weight_price + " руб./кг.";
        }
        ...
        if (action_record && action_record.get('action_name') !== ' ')
        {
            ...
            /*Если есть глобальная процентная акция и прайс штучный*/
            if (record.get('price_type') == "Штучный" && action_record.get('action_type') == 'Процентная')
            {
                discount = ((record.get('price') * (1-action_record.get('action_value')))/record.get('price'))*100;
                result_price = Math.floor (record.get('price') * action_record.get('action_value'));

                wear_name += " ** Акция: " + action_record.get('action_name') + "; Скидка: " + discount.toPrecision(2).toString() + "%; ** Итоговая цена: " + result_price.toString() + " руб./шт. **";

                record.set('result_price', result_price);
            }
            /* если есть акция локальная */
            else if (record.get('price_type') == "Штучный" && ((record.get('action_name') == "первый контакт" && this.getAddOrderPanel().order_count === 0) || (record.get('action_name') == "первый контакт" && this.getAddOrderPanel().order_count === 0) || (record.get('action_name') !== "первый контакт" && record.get('action_name') !== "")))
            {
                if (record.get('action_type') == "Рублевая")
                {
                    discount = ((record.get('price') - record.get('action_value'))/record.get('price'))*100;
                    result_price = Math.floor (record.get('action_value'));
                }
                else if (record.get('action_type') == "Процентная")
                {
                    discount = ((record.get('price') * (1-record.get('action_value')))/record.get('price'))*100;
                    result_price = Math.floor (record.get('price') * record.get('action_value'));
                }


                wear_name += " ** Акция: " + record.get('action_name') + "; Скидка: " + discount.toPrecision(2).toString() + "%; ** Итоговая цена: " + result_price.toString() + " руб./шт. **";

                record.set('result_price', result_price);
            }


            /* Есть глобальная акция на весовой текстиль или процентная акция и прайс весовой */
            if ((action_record.get('action_type') == 'На весовой текстиль' || action_record.get('action_type') == 'Процентная') && record.get('is_home_weight') === 1 && record.get('price_type') == "Весовой")
            {
                discount = ((add_order_panel.home_weight_price * (1-action_record.get('action_value')))/add_order_panel.home_weight_price)*100;
                result_price = Math.floor (add_order_panel.home_weight_price * action_record.get('action_value'));

                wear_name += " ** Акция: " + action_record.get('action_name') + "; Скидка: " + discount.toPrecision(2).toString() + "%; ** Итоговая цена: " + result_price.toString() + " руб/кг.. **";

                add_order_panel.home_weight_result_price = result_price;
            }


            /* Есть глобальная акция на весовую одежду или процентная акция и прайс весовой */
            if ((action_record.get('action_type') == 'На весовую одежду' || action_record.get('action_type') == 'Процентная') && record.get('is_home_weight') === 0 && record.get('price_type') == "Весовой")
            {
                discount = ((add_order_panel.dress_weight_price * (1-action_record.get('action_value')))/add_order_panel.dress_weight_price)*100;
                result_price = Math.floor (add_order_panel.dress_weight_price * action_record.get('action_value'));

                wear_name += " ** Акция: " + action_record.get('action_name') + "; Скидка: " + discount.toPrecision(2).toString() + "%; ** Итоговая цена: " + result_price.toString() + " руб/кг.. **";

                add_order_panel.dress_weight_result_price = result_price;
            }
        }
        /* если есть акция локальная */
        else if (record.get('price_type') == "Штучный" && ((record.get('action_name') == "первый контакт" && this.getAddOrderPanel().order_count === 0) || (record.get('action_name') !== "первый контакт" && record.get('action_name') !== "")))
        {
            if (record.get('action_type') == "Рублевая")
            {
                discount = ((record.get('price') - record.get('action_value'))/record.get('price'))*100;
            ...
            wear_name += " ** Акция: " + record.get('action_name') + "; Скидка: " + discount.toPrecision(2).toString() + "%; ** Итоговая цена: " + result_price.toString() + " руб. **";

            record.set('result_price', result_price);
        }
        /* нет ни глобальных ни локальных акций*/
        else
        {
            add_order_panel.home_weight_result_price = add_order_panel.home_weight_price;
            add_order_panel.dress_weight_result_price = add_order_panel.dress_weight_price;
            record.set('result_price', record.get('price'));
    ...
    create_wear_name_and_calc_result_price_exists: function(record) {
        ...
        if (action_record && action_record.get('action_name') !== ' ')
        {
            ...
            /* если есть акция локальная */
            else if (record.get('price_type') == "Штучный" && record.get('action_name') !== "")
            {
                if (record.get('action_type') == "Рублевая")
                {
                    discount = ((record.get('price') - record.get('action_value'))/record.get('price'))*100;
    ...
    create_wear_name_and_calc_result_price_exists_remote: function(record, action_record) {
        var wear_name = record.get('item_type_name') + " (" + record.get('gender') + "; " + record.get('color');
        ...
        else
        {
            ...
            if (record.get('is_home_weight') === 0)
                wear_name += " ** Цена " + record.get('dress_weight_price') + " руб./кг.";
            else
                wear_name += " ** Цена " + record.get('home_weight_price') + " руб./кг.";
        }
        ...
        if (action_record && action_record.get('action_name') !== ' ')
        {
            ...
            if (record.get('price_type') == "Штучный" && action_record.get('action_type') == 'Процентная')
            {
                ...
                record.set('result_price', result_price);
                record.set('discount', Math.ceil(discount));
                record.set('result_action_name', action_record.get('action_name'));
            ...
            else if (record.get('price_type') == "Штучный" && record.get('action_name') !== "")
            {
                ...
                record.set('result_price', result_price);
                record.set('discount', Math.ceil(discount));
                record.set('result_action_name', record.get('action_name'));
            }
            else
            {
                record.set('result_price', record.get('price'));
            ...
            if ((action_record.get('action_type') == 'На весовой текстиль' || action_record.get('action_type') == 'Процентная') && record.get('is_home_weight') === 1 && record.get('price_type') == "Весовой")
            {
                discount = ((record.get('home_weight_price') * (1-action_record.get('action_value')))/record.get('home_weight_price'))*100;
                result_price = Math.floor (record.get('home_weight_price') * action_record.get('action_value'));
                ...
                record.set('home_weight_result_price', result_price);
                record.set('result_action_name', action_record.get('action_name'));
                record.set('discount', Math.ceil(discount));
            }
            else
                record.set('home_weight_result_price', record.get('home_weight_price'));


            /* Есть глобальная акция на весовую одежду или процентная акция и прайс весовой */
            if ((action_record.get('action_type') == 'На весовую одежду' || action_record.get('action_type') == 'Процентная') && record.get('is_home_weight') === 0 && record.get('price_type') == "Весовой")
            {
                discount = ((record.get('dress_weight_price') * (1-action_record.get('action_value')))/record.get('dress_weight_price'))*100;
                result_price = Math.floor (record.get('dress_weight_price') * action_record.get('action_value'));

                wear_name += " ** Акция: " + action_record.get('action_name') + "; Скидка: " + discount.toPrecision(2).toString() + "%; ** Итоговая цена: " + result_price.toString() + " руб/кг.. **";

                record.set('dress_weight_result_price', result_price);
                record.set('result_action_name', action_record.get('action_name'));
                record.set('discount', Math.ceil(discount));
            }
            else
                record.set('dress_weight_result_price', record.get('dress_weight_price'));
        }
        /* если есть акция локальная */
        else if (record.get('price_type') == "Штучный" && record.get('action_name') !== "")
        {
    ...
    set_result_price_for_peace_item_with_local_action: function(record, order_count, name_dist) {
        ...
        if (item_action_name != ' ' && ((item_action_name == 'первый контакт' && order_count === 0 && name_dist == 'add_order') || (item_action_name !== 'первый контакт' && name_dist == 'add_order') || (item_action_name !== '' && (name_dist == 'edit_order' || name_dist == 'create_contract'))))
        {
